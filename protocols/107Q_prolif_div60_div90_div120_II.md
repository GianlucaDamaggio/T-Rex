# AC2021 107Q_prolif_div60_div90_div120_II

## STRAGLR Run 107Q_prolif_div60_div90_div120_II
...
### FASTQ2FASTA 107Q_prolif_div60_div90_div120_II

107Q_prolif_div60_div90_div120_II

```bash
mkdir /lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/fastq2fasta

for n in 01 02 03 04 05 06 07 08 09 10 11 12; do zcat /lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/basecalling/pass/barcode${n}/*.fastq.gz | awk '{if(NR%4==1) {printf(">%s\n",substr($0,2));} else if(NR%4==2) print;}' > /lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/fastq2fasta/barcode${n}_allreads.fasta ; done
```

## BLASTN 107Qbarcode 107Q_prolif_div60_div90_div120_II
...
```bash
for n in 01 02 03 04 05 06 07 08 09 10 11 12; do bash bash-merge_100_BAM.sh /lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/alignment/barcode${n}_WG ; done
```

CL Job submission:

```bash
mkdir /lustrehome/gianluca/straglr/output/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II

cd /lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/alignment/
...
-a "out_dir=/lustrehome/gianluca/straglr/output/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/" \
-a "bam=/lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/alignment/barcode${n}_WG/${f2}" \
...
```bash
cd /lustrehome/gianluca/straglr/output/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II
...
ALIGNMENT=/lustrehome/gianluca/cattaneo/data/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/20211109_1755_MN37986_FAQ75854_4cfd8afc/analysis/alignment

BLASTN=/lustrehome/gianluca/straglr/blastn/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II

STRAGLR=/lustrehome/gianluca/straglr/output/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II
...
```bash
mkdir /Users/gianlucadamaggio/projects/cattaneo/straglr/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/

for n in 01 02 03 04 05 06 07 08 09 10 11 12 ; do rsync -avh --progress gianluca@ui02.recas.ba.infn.it:/lustrehome/gianluca/straglr/output/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/barcode${n} /Users/gianlucadamaggio/projects/cattaneo/straglr/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/ ; done
```
...
for n in 01 02 03 04 05 06 07 08 09 10 11 12; do rsync -avh --progress gianluca@ui02.recas.ba.infn.it:/lustrehome/gianluca/straglr/output/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/barcode${n}_v4 /Users/gianlucadamaggio/projects/cattaneo/straglr/AC2021_NANOPORE_PCR10/107Q_Prolif_div60_div90_div120_II/ ; done
```
-->